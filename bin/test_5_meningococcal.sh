...
if [[ "$CI_PWD" != "" ]]; then
  ...
  -e COMPUTER=test \
  raw996/internal_surveillance:test Rscript /git/internal_surveillance/dofiles/test_5_meningococcal.R
else
  ...
  internal_rstudio Rscript /git/internal_surveillance/dofiles/test_5_meningococcal.R
